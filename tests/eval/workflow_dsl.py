...
class WorkflowRetrievalConfig(TypedDict):
    """Settings exported by the Knowledge Retrieval node."""
...
def load_workflow_retrieval_config() -> WorkflowRetrievalConfig:
    ...
    if settings.get("reranking_mode") != "weighted_score":
        raise WorkflowConfigError("retrieval must use weighted score")
